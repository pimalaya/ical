//! # DIR parameter lens
//!
//! The `DIR` parameter lens: the directory entry reference (RFC 5545 3.2.6).
...
/// The `DIR` parameter lens.
#[allow(non_camel_case_types)]
pub struct DIR;

impl IcalParamLens for DIR {
    const KIND: IcalParamKind = IcalParamKind::Dir;
