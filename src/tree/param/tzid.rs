//! # TZID parameter lens
//!
//! The `TZID` parameter lens: the time-zone reference (RFC 5545 3.2.19).
...
/// The `TZID` parameter lens.
#[allow(non_camel_case_types)]
pub struct TZID;

impl IcalParamLens for TZID {
    const KIND: IcalParamKind = IcalParamKind::TzId;
